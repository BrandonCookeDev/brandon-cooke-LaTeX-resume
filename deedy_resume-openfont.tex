...
\begin{tightemize} 
\item Created \href{http://npmjs.com/package/smashgg.js}{\custombold{smashgg.js}}, a comprehensive \href{www.smash.gg}{\custombold{Smash.GG}} public API wrapper. \item Used Python, Angular, and MongoDB to create an automated tournament-participant ranking app, \href{https://notgarpr.com}{\custombold{NotGarPR}}. \item Used VueJS and ReactJS to create responsive, html stream scoreboards. \item Used MEAN to create the initial incarnation of Recursion Production's website.
\end{tightemize}
\sectionsep
...
\location{Atlanta, Georgia}
\begin{tightemize}
\item Aided in the coding and creation of \href{https://play.google.com/store/apps/details?id=com.gmail.japa.arialdis.tasteslikechickenlite&hl=en}{\custombold{Tastes Like Chicken}}, a lightweight restaurant discovery and rating applicaiton using Java for Android. \item Used C to create multiple OS components including a multi-level cache.
\end{tightemize}
\sectionsep
